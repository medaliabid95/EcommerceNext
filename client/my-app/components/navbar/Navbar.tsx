    ...
    <AppBar className='navbr' position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            {pages.map((page) => (
              <Button
                ...
                onClick={page === 'Home' ? handleHome : page === 'Product' ? handleProduct  : handleCloseNavMenu}
          ...
          <Box sx={{ flexGrow: 0 }}>
            <Tooltip title="Open youre profile">
            
              <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                <Avatar alt="Remy Sharp" src="https://www.codeproject.com/KB/GDI-plus/ImageProcessing2/img.jpg" />
              </IconButton>
            </Tooltip>
            <Menu
              sx={{ mt: '45px' }}

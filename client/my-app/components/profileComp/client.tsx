  ...
  return (
    <div className="error-container">
      <div className="error">
        ...
        <div className="error__title">sorry , only sellers has personal accounts !</div>
        <div className="error__close"><svg height="60" viewBox="0 0 60 60" width="60" xmlns="http://www.w3.org/2000/svg"><path d="m15.8333 5.34166-1.175-1.175-4.6583 4.65834-4.65833-4.65834-1.175 1.175 4.65833 4.65834-4.65833 4.6583 1.175 1.175 4.65833-4.6583 4.6583 4.6583 1.175-1.175-4.6583-4.6583z" fill="#393a37"></path></svg></div>
      </div>
    </div>
  )
}
